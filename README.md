...
# 👋 Hi, I'm Akshaya Dharshini

### 🎓 B.Tech AI & Data Science Student | 💻 Aspiring Software Developer | 🤖 AI & ML Enthusiast

<img src="https://readme-typing-svg.demolab.com?font=Poppins&weight=600&size=24&duration=3500&pause=1000&color=8A2BE2&center=true&vCenter=true&width=900&lines=Building+intelligent+solutions+for+a+better+future+%F0%9F%9A%80;AI+%7C+Data+Science+%7C+Software+Development;Learning+%E2%86%92+Building+%E2%86%92+Solving+%E2%86%92+Growing" />
...
📊 Interested in **Data Science and data-driven solutions**

🧩 Strengthening my skills in **Java, Python, SQL, DSA & Problem Solving**
...
### 💡 From Ideas → 🚀 Projects → 🏆 Hackathons → 🌐 Real-World Solutions
...
An AI-powered knowledge and meeting assistant that helps users capture, organize, and interact with information from meetings and uploaded files.

**Tech Stack**

`JavaScript` `Node.js` `AI` `Web Development`
...
A healthcare-focused hospital navigation and assistance system designed to improve the patient experience and make hospital services easier to navigate.
...
An intelligent railway maintenance and block-planning solution developed for **Smart India Hackathon 2026**.

Combines AI, railway data, geospatial analysis and optimization to support smarter railway maintenance planning.

**Tech Stack**

`Next.js` `React` `FastAPI` `Python`

`XGBoost` `OR-Tools` `Leaflet GIS`
...
A Chrome extension designed to detect manipulative website patterns such as urgency, scarcity, confirmshaming, forced action, hidden costs and misleading buttons.
...
<img src="https://img.shields.io/badge/🛡️%20Chrome%20Extension-IN%20DEVELOPMENT-4285F4?style=for-the-badge&logo=googlechrome&logoColor=white"/>
...
`JavaScript` `JSX` `HTML` `CSS` `Python`
...
A machine learning-based project that identifies Indian cattle breeds using image classification techniques.
...
An image classification project that uses deep learning to identify different types of fruits.
...
<img src="https://img.shields.io/badge/🧠%20DEEP%20LEARNING-PROJECT-FF6F00?style=for-the-badge&logo=tensorflow&logoColor=white"/>
...
A data-driven project focused on weather analysis and forecasting.
